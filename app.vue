<template>
  <div class="app-container">
    ...
    <pomodoro-components-pomodoro-settings/>
    <pomodoro-components-timer-component/>
    <svg
      @click="openModal()"
    ...
    <pomodoro-components-settings-modal class="settings-modal" v-show="showModal" @closeModal="closeModal()"/>
   </div>
</template>
<script setup>
